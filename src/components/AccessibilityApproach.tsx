        ...
        <div className="max-w-4xl mx-auto text-center space-y-8">
          <div className="space-y-4">
            <h2 className="text-4xl lg:text-5xl font-bold font-heading">
              Our <span className="brand-gradient">Approach</span>
            </h2>
          ...
          <div className="grid md:grid-cols-3 gap-8 mt-16">
            ...
            <div className="text-center space-y-4">
              ...
              <p className="text-muted-foreground">User-centered design with accessibility at its core</p>
            </div>
            ...
            <div className="text-center space-y-4">
              ...
              <p className="text-muted-foreground">Implementation following accessibility standards and best practices</p>
            </div>
            ...
            <div className="text-center space-y-4">
              ...
              <p className="text-muted-foreground">Continuous monitoring and improvement of accessible services</p>
            </div>
          </div>
        </div>
      </div>
